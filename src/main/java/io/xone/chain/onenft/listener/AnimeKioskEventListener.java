...
//			INftTakenEventService nftTakenEventService, INftListingEventService nftListingEventService, INftDelistEventService nftDelistEventService) {
...
//		this.nftDelistEventService = nftDelistEventService;
//	}
//
//	@Override
...
//
//	@Scheduled(fixedDelay = 5000)
//	private void subscribeKioskDelist() {
//		fetchAndProcessEvents("NFTDelisted", this::handleNFTDelistEvent);
//	}
//
...
//	}
//
//	private void handleNFTDelistEvent(OneChainEvent event) {
//		String txHash = event.getId().getTxDigest();
//		String walletAddress = event.getSender();
//		String eventType = event.getType();
//		String kioskId = null;
...
//		}
//
//		nftDelistEventService.handleNFTDelistEvent(txHash, walletAddress, eventType, kioskId, nftId, timestampMs);
//	}
//
//}
